export const timelineItemsList = [
    ...
    },
    {
      ...
      description: 'Food Munch is a responsive Website for user-centric food tech platform.',
    ...
    },
    {
      ...
      description:
        'Learned the fundamental concepts in JavaScript and apply them to build dynamic and interactive web applications like Counter, Guessing Game, Chat Web app, E-commerce web app, etc.',
      duration: '20 days',
      tagsList: [
        {
    ...
    },
    {
      ...
      duration: '6 hrs',
      projectUrl: 'https://prasadecom2.ccbp.tech',
    },
    {
      id: '7bc3f006-f0f1-4574-924b-17c480556734',
      categoryId: 'PROJECT',
      title: '27 MARCH 2022',
      projectTitle: 'Jobby App',
      description:
        'The Jobby app is a job lisiting app for various roles and position. The user can login and check the job details based on employment type, salary range and job title etc.',
      imageUrl: 'https://i.postimg.cc/259VdtMV/Jobby.png',
      duration: '5 hr',
      projectUrl: 'https://prasadsjobapp.ccbp.tech/jobs',
    },
    {
      id: '7bc3f006-f0f1-4574-924b-17c444556734',
      categoryId: 'PROJECT',
      title: '06 April 2022',
      projectTitle: 'Covid Tracker',
      description:
        'The Covid tracker app keeps track of the covid-19 cases resgistered in various parts of India. It also has data related to confirmed, active, deceased, and recovered patients',
      imageUrl: 'https://i.postimg.cc/7ZryJNL0/covid.png',
      duration: '10 hr',
