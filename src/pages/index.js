...
export default function Home() {
  ...
  return (
    <>
        ...
        <Layout className='pt-0'>
          <div className='w-full flex flex-col lg:flex-row'>
            <div className='flex items-center lg:justify-between justify-center w-full '>
              <Image src={dp} alt='Prasad Boye' className='h-auto' />
            </div>
      ...
      <Layout>
      <h1 className='sm:text-5xl text-3xl font-bold items-center justify-center text-center'>Testimonials</h1>
          <section class="text-gray-600 body-font">
            <div class="container px-5 py-24 mx-auto">
              <div class="flex flex-wrap -m-4">
                ...
                onHoverStart={e => {}}
                onHoverEnd={e => {}} className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                ...
                <motion.div
                  ...
                  <div class="h-full text-center">
                    ...
                    <p class="leading-relaxed">As the team lead, I&apos;ve had the pleasure of collaborating closely with Prasad Boye. His coding proficiency and commitment to quality are unmatched. Prasad&apos;s ability to tackle challenging problems head-on and deliver stellar results has been instrumental in our team&apos;s success. With Prasad&apos;s expertise in our team, we&apos;re not just meeting expectations – we&apos;re delivering high quality products.</p>
                    <span class="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
                ...
                <motion.div
                  whileHover={{ scale: 1.1 }}
                  onHoverStart={e => {}}
                  onHoverEnd={e => {}} className="lg:w-1/3 lg:mb-0 p-4">
                  <div class="h-full text-center">
